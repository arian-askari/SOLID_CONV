...
class ConversationGenerator:
    ...
    def generate_dialogue(self, topic, topic_type, context, list_of_intents, first_question):
        ...
        return {"generated_dialogue": utterances_with_intents, "entity_card_obj": None}, combined_instructions
